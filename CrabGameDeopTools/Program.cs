...
namespace CrabGameDeopTools
{
    internal class Program
    {
        ...
        static IEnumerable<TypeReference> GetAllTypeReferences(ModuleDefinition module)
        {
            foreach (var td in GetAllTypeDefinitions(module))
            {
                if (td.BaseType != null)
                    yield return td.BaseType;
                ...
                foreach (var m in td.Methods)
                {
                    ...
                    foreach (var g in m.GenericParameters)
                        foreach (var c in g.Constraints)
                            yield return c.ConstraintType;
